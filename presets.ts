...
export const personalDetailsPreset: PersonalDetails = {
    fullName: 'Maguette Dramé',
    email: 'maguettedrame@naatal.shop',
    phone: '+221 77 XXX XX XX',
    address: 'Cambérenre, Dakar, Senegal',
...
export const educationsPreset: Education[] = [
    ...
    //     endDate: '2024-06-01',
    //     description: 'Spécialisation en sécurité  et cryptage de données.'
    // }
];
...
export const languagesPreset: Language[] = [
    { id: 'uuid-6', language: 'Français', proficiency: 'Avancé' },
    { id: 'uuid-7', language: 'Anglais', proficiency: 'Débutant' }
];
